...
- PR #358 "align mattress box spring config pricing" is merged and is the current main baseline at `729f761 align mattress box spring config pricing (#358)`. Version remains `0.12.0`; version parity passed, GPT grounding parity passed, and `tests/test_pricing_invariants.py` passed with 586 tests and 1 warning. Mattress/boxspring config is now aligned to `$60` each. No runtime pricing behavior changed.

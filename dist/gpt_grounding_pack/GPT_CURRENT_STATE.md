...
- Current verified baseline after PR #318 and current main commit `ef569102df5f12a4f92acbc8054cf645aeffe2e5`: version is `0.12.0`, version parity passed, GPT grounding parity passed, full pytest passed with 719 tests, pip-audit was clean, and Render parity was verified at version `0.12.0` with commit `ef569102df5f`.

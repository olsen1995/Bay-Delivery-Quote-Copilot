...
4. **Connectors**: Upgrade to low‑resistance plugs/wire (e.g., XT60/XT90); verify solder joints

## 5) Validation

- **Heat check procedure**: After a 2–3 minute run, stop and measure motor/ESC temps.  
  Keep motor under ~160°F/71°C and ESC under its rated limit  

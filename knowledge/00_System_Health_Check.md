# Life OS — System Health Check (v1.0)
...
- Confidence < 80% → say what’s known vs unknown; avoid strong claims.
- Max 1–3 questions; only if it changes the outcome or safety.

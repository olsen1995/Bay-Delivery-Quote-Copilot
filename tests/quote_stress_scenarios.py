...
NORMAL_SCENARIOS: list[QuoteStressScenario] = [
    ...
    },
    {
        ...
        "payload": _payload(
            ...
            estimated_hours=4.0,
            crew_size=2,
            pickup_address="45 Pickup Rd, North Bay, ON",
            dropoff_address="67 Dropoff Ave, North Bay, ON",
        ),
        "expected_status": 200,
    ...
    },
    {
        ...
        "payload": _payload(
            ...
            estimated_hours=0.0,
            pickup_address="11 Warehouse Way, North Bay, ON",
            dropoff_address="22 Customer Crescent, North Bay, ON",
        ),
        "expected_status": 200,
...
EDGE_MARGIN_RISK_SCENARIOS: list[QuoteStressScenario] = [
    ...
    },
    {
        ...
        "payload": _payload(
            ...
            estimated_hours=4.0,
            crew_size=2,
            pickup_address="90 Main Floor Rd, North Bay, ON",
            dropoff_address="91 Main Floor Rd, North Bay, ON",
            access_difficulty="normal",
        ),
        "expected_status": 200,
        "expected_service_type": "small_move",
    ...
    },
    {
        ...
        "payload": _payload(
            ...
            estimated_hours=4.0,
            crew_size=2,
            pickup_address="90 Stairwell Rd, North Bay, ON",
            dropoff_address="91 Stairwell Rd, North Bay, ON",

...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Remove wall cabinets near plumbing", 650.0, "medium_material"),
        ("Remove wall shelf near electrical panel", 650.0, "normal"),
        ...
        ("Remove ceiling fan near wiring", 650.0, "normal"),
        ("Remove ceiling light near wiring", 650.0, "normal"),
        ...
        ("Old wooden shed cleanup", 650.0, "normal"),
        ("Old wooden shed cleanup and removal", 650.0, "normal"),
        ("Old fence cleanup", 650.0, "normal"),
        ("Old fence boards cleanup", 650.0, "normal"),
        ("Old fence boards cleanup and removal", 650.0, "normal"),
        ("Full shed debris removal", 650.0, "normal"),
        ("Waterproofing material demo", 650.0, "normal"),
        ("Proofing demolition", 650.0, "normal"),
        ("Remove wall near service counter line", 650.0, "normal"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("old wooden shed", 1000.0, 1130.0, "structure", True),
        ("16x10 shed in backyard", 1000.0, 1130.0, "structure", True),
        ("old fence", 1000.0, 1130.0, "structure", True),
        ("old wooden carport", 1000.0, 1130.0, "structure", True),
        ...
        ("Backyard drywall demolition", 750.0, 847.5, "access_risk", True),
        ("Back yard drywall demo", 750.0, 847.5, "access_risk", True),
        ("Backyard cabinet demolition", 750.0, 847.5, "access_risk", True),
    ],
)

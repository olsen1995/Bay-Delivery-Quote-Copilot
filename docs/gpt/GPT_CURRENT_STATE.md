...
- PR #333 Demolition Calibration Pricing Safeguards is in review: the branch adds narrow runtime safeguards in `app/quote_engine.py` for calibration-proven demolition underquote scenarios. Additional protected categories include large/long-duration deck or shed structure demolition/demo wording, structure-heavy roofing/shingle/debris demolition, and utility-adjacent interior selective demolition near plumbing/HVAC/ducting/furnace/water-heater/pipe/utility-line context. Admin owner-review queue filtering mirrors these internal owner-review signals without reading manual calibration entries or creating database-driven pricing. Bare utility-room location notes, generic interior wall removal, and small controlled drywall/plaster demolition remain protected against false utility-adjacent escalation. GPT may explain these safeguards but must not calculate or override prices.

...
SEED_JOBS: tuple[dict[str, Any], ...] = (
    ...
    {
        "job_id": "test-simulated-labour-underpriced-move",
        "quote_id": "quote-test-simulated-labour-underpriced-move",
        "request_id": "request-test-simulated-labour-underpriced-move",
        "created_at": "2026-05-08T12:00:00",
        "completed_at": "2026-05-08T14:30:00",
        "customer_name": f"{TEST_LABEL} - Local Costing Review",
        "customer_phone": "000-000-0000",
        "job_address": f"{TEST_LABEL} - North Bay local dev only",
        "job_description_customer": "TEST / Simulated labour-underpriced move",
        "job_description_internal": (
            f"{TEST_LABEL} local-only seed record. Demonstrates LABOUR_UNDERPRICED_RISK: "
            "2-person crew for 2.5 hours; collected $350 is below the 2-person crew rate floor ($412.50)."
        ),
        "service_type": "small_move",
        "cash_total_cad": 310.0,
        "emt_total_cad": 350.30,
        "notes": f"{TEST_LABEL} seed job for desktop completed-job costing review.",
        "closeout_notes": f"{TEST_LABEL} closeout note. Final collected: $350 EMT / e-transfer.",
        "request_json": {
            "source": TEST_LABEL,
            "customer_facing_quote": "310 plus HST",
            "expected_known_total_cost_cad": 150.0,
            "expected_profit_cad": 200.0,
            "expected_margin_percent": 57.1,
            "notes": "Collected below 2-person crew rate floor of $412.50 for 2.5 hours.",
        },
        "costing": {
            "actual_hours": 2.5,
            "actual_crew_size": 2,
            ...
            "payment_status": "paid_in_full",
            "job_profit_status": "profitable",
            "quote_accuracy_note": "TEST / SIMULATED expected profit $200 and margin 57.1%.",
            "disposal_receipt_note": "TEST / SIMULATED no disposal cost.",
        },
    },
)
